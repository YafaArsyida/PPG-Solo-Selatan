<div wire:ignore.self class="modal fade" id="ModalDeleteGenerus" tabindex="-1" aria-labelledby="deleteGenerusLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body px-4 pb-5 pt-2 text-center">
                ...
                <div class="mb-2">
                    ...
                    <h3 class="fw-bold mb-2" id="deleteGenerusLabel">
                        Hapus Data Generus?
                    </h3>

                    <p class="text-muted mb-0 lh-lg px-lg-4">
                        Data generus akan dihapus secara permanen dari sistem.
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 fs-13">
                                Pastikan data generus tidak memiliki relasi data aktif
            ...
            <div class="modal-footer border-0 pt-0 px-4 pb-4 justify-content-center">
                ...
                <button type="button" class="btn btn-danger rounded-pill px-4" wire:click="deleteGenerus">
