        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    {{-- DELETE --}}
                    <a href="#ModalDeleteGenerus" data-bs-toggle="modal" class="btn btn-soft-danger btn-sm rounded-pill px-3"
                        title="Hapus Data Generus" wire:click.prevent="$emit('GenerusDelete', {{ $row->ms_generus_id }})">
                ...
                <td>
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        ...
                        {{-- DETAIL --}}
                        <a href="#ModalDetailGenerus" data-bs-toggle="modal" class="btn btn-soft-primary btn-sm rounded-pill px-3"
                            title="Lihat Detail Generus" wire:click.prevent="$emit('GenerusDetail', {{ $row->ms_generus_id }})">
                            <i class="ri-eye-line me-1"></i>
                            Detail
                        </a>
                
                        {{-- EDIT --}}
                        <a href="#ModalEditGenerus" data-bs-toggle="modal" class="btn btn-warning btn-sm rounded-pill px-3"
                            title="Edit Data Generus" wire:click.prevent="$emit('GenerusEdit', {{ $row->ms_generus_id }})">
