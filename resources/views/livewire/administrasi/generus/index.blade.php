        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-4">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <button type="button"
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#ModalGenerusCreate"
    ...
    <div class="card-body pt-0 px-4 pb-4">
        ...
        <div class="border rounded-4 overflow-hidden">
            ...
            <div class="bg-light px-3 pt-3">
                ...
                <ul class="nav nav-pills gap-2 flex-nowrap overflow-auto pb-3"
                    role="tablist">
            ...
            <div class="bg-white p-3 p-lg-4">
                ...
                <div class="tab-content">
                    ...
                    {{-- SEMUA GENERUS --}}
                    <div class="tab-pane fade {{ $activeTab === 'semua' ? 'show active' : '' }}"
                        id="tabSemua"
                        role="tabpanel">
                    ...
                    <div class="tab-pane fade {{ $activeTab === 'kelompok-'.$grp->ms_kelompok_id ? 'show active' : '' }}"
                        id="tabKelompok{{ $grp->ms_kelompok_id }}"
                        role="tabpanel">

                        @php
                            $listGenerus = $allGenerus->where(
                                'ms_kelompok_id',
                                $grp->ms_kelompok_id
                            );
                        @endphp
