                                        ...
                                        <label class="border rounded-4 p-4 d-block h-100 cursor-pointer transition">
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted fs-13 mb-0">
                                                        Kegiatan hanya dilakukan satu kali
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted fs-13 mb-0">
                                                        ...
                                                        pada hari tertentu setiap minggu.
                                                    </p>
                                ...
                                <div class="alert alert-info border-0 rounded-4 mt-4 mb-0">
                                    ...
                                    <div class="d-flex align-items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 fs-13">
                                                Lokasi kegiatan rutin dapat dikonfirmasi ulang
                                                saat presensi apabila terjadi rotasi tempat kegiatan.
                                            </p>
                        ...
                        <div class="col-12">
                            ...
                            <div class="border rounded-4 p-4">
                                ...
                                <textarea class="form-control rounded-3" rows="4" wire:model.defer="deskripsi"
                                    placeholder="Tambahkan deskripsi atau catatan kegiatan (opsional)"></textarea>
