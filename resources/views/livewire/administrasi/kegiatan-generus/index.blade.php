                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                {{-- DETAIL --}}
                                <a href="#ModalDetailKegiatan" data-bs-toggle="modal" class="btn btn-light btn-sm"
                                    title="Detail"
                                ...
                                {{-- EDIT --}}
                                <a href="#ModalEditKegiatan" data-bs-toggle="modal" class="btn btn-light btn-sm"
                                    title="Edit"
                                ...
                                {{-- DELETE --}}
                                <a href="#ModalDeleteKegiatan" data-bs-toggle="modal" class="btn btn-light btn-sm"
                                    title="Hapus"
