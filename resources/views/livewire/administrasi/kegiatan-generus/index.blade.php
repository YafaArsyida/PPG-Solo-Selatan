                ...
                <tbody>
                    ...
                    <tr class="fw-semibold">
                        ...
                        <td class="text-center">
                            {{-- DELETE --}}
                            <a href="#ModalDeleteKegiatan" data-bs-toggle="modal" wire:click.prevent="$emit('KegiatanDelete', {{ $item->ms_kegiatan_generus_id }})"
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <a href="#ModalEditKegiatan" data-bs-toggle="modal" class="btn btn-primary btn-sm rounded-pill px-3"
                                    wire:click.prevent="$emit('KegiatanEdit', {{ $item->ms_kegiatan_generus_id }})" title="Edit Kegiatan">
