                                                ...
                                                <label
                                                    ...
                                                    <div class="d-flex align-items-start gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-13 mb-0">
                                                                Digunakan untuk event atau kegiatan pada tanggal
                                                                tertentu.
                                                            </p>
                                                ...
                                                <label
                                                    ...
                                                    <div class="d-flex align-items-start gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-13 mb-0">
                                                                Digunakan untuk kegiatan mingguan yang berulang.
                                                            </p>
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-6 col-md-3">
                                                ...
                                                <label
                                                    class="border rounded-3 p-3 w-100 cursor-pointer bg-light-subtle">
                                        ...
                                        <div class="alert alert-info border-0 rounded-4 mb-0">
                                            ...
                                            <div class="d-flex gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fs-13">
                                                        Lokasi kegiatan dapat disesuaikan kembali saat presensi apabila
                        ...
                        <div class="col-12">
                            ...
                            <div class="border rounded-4 p-4">
                                ...
                                <textarea class="form-control rounded-3" rows="4" wire:model.defer="deskripsi"
                                    placeholder="Tambahkan catatan atau deskripsi kegiatan..."></textarea>
