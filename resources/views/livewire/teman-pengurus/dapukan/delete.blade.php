<div wire:ignore.self class="modal fade" id="ModalDeleteDapukan" tabindex="-1" aria-labelledby="deleteRecordLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
          ...
          mb-3">
                    ...
                    <p class="text-muted mb-0 lh-lg px-lg-4">
                        Data dapukan akan dihapus permanen dari sistem.
                    </p>
                </div>
                {{-- WARNING --}}
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 fs-13">
                                Dapukan tidak dapat dihapus apabila sudah digunakan pengurus.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer border-0 pt-0 px-4 pb-4 justify-content-center">
                ...
                <button type="button" class="btn btn-danger rounded-pill px-4" wire:click="deleteDapukan">
