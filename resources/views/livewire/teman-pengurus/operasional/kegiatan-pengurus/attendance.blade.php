            ...
            <table id="Attendance" class="table align-middle table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="avatar-xs flex-shrink-0">
                                    <div class="avatar-title 
                                        {{ $row->ms_pengurus->jenis_kelamin == 'perempuan'
                                        ? 'bg-danger-subtle text-danger'
                                        : 'bg-primary-subtle text-primary' 
                                        }} 
                                        rounded-circle fw-semibold">
                                        {{ strtoupper(substr($row->ms_pengurus->nama_pengurus, 0, 1)) }}
                                    </div>
                                </div>
                                <div>
                                    <div class="fw-semibold">
                                        {{ $row->ms_pengurus->nama_pengurus }}
                                    </div>
                                    <small class="text-muted">
                                        {{ strtoupper($row->ms_pengurus->jenis_kelamin) }}
                                    </small>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="fw-semibold">
                                Kelompok {{ $row->ms_pengurus->ms_kelompok->nama_kelompok ?? '-' }}
                            </div>
                        </td>
                        {{-- STATUS --}}
                        <td>
