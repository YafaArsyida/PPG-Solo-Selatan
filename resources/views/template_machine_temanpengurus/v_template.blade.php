...
<head>
    @include('template_machine_temanpengurus.v_head')
</head>
...
<body>
    ...
    <div id="layout-wrapper">
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{
                                            Auth::user()->nama ?? 'Guest' }}</span>
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{
                                            Auth::user()->peran ?? 'Unknown Role' }}</span>
                                    </span>
                                </span>
                            </button>
        ...
        <!-- ========== Left Sidebar Start ========== -->
        @include('template_machine_temanpengurus.v_sidebar')
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            <!-- End Page-content -->
            {{-- @include('template_machine_temanpengurus.v_footer') --}}
            {{-- sxtends --}}
        </div>
        <!-- end main content-->
    ...
    <!-- JAVASCRIPT -->
    @include('template_machine_temanpengurus.v_script')
    @livewireScripts
