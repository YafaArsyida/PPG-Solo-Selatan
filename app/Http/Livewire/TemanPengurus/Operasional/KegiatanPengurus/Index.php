...
class Index extends Component
{
    ...
    public function getQueryProperty()
    {
        $query = KegiatanPengurus::query()
            ...
            ->withSum('tr_infaq_pengurus', 'nominal')

            ->withCount([
                'presensi_kegiatan_pengurus as hadir_count' => function ($q) {
                    $q->where('status_hadir', 'hadir');
                },
                'presensi_kegiatan_pengurus as izin_count' => function ($q) {
    ...
    {
        return view('livewire.teman-pengurus.operasional.kegiatan-pengurus.index',[
